  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="row form-group">
                    <div class="col-md-12">
                        <label for="">Ingrese los datos del Objeto de Gasto:</label>
                    </div>
                    <div class="col-md-2 pt-3" >
                        <label for="">Cod :</label>
                    </div>
                    <div class="col-md-10 pt-3">
                        <input type="number" class="form-control" :class="objgast ? '' : 'bg-warning'" v-model="objgast" placeholder="Ingrese el Id de Objeto de Gasto">
                    </div>
                    <div class="col-md-2 pt-3" >
                        <label for="">Detalle :</label>
                    </div>
                    <div class="col-md-10 pt-3">
                        <input type="text" class="form-control" :class="descrip ? '' : 'bg-warning'" v-model="descrip" placeholder="Ingrese el Detalle de D.A.">
                    </div>
...
const app = new Vue({
        ...
        methods: {
            ...
            axios.post('/new_categoria', data).then(response => {
                $('#modal1').modal('hide');
            });
            ...
            editar(){
                    axios.get('/geteditcategoria/'+this.cod).then(response => {
                    this.dass = response.data;
                    this.objgast = this.dass[0].objgast;
